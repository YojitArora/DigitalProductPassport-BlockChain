        ...
        <div style={{ background: "var(--bg-secondary)", padding: "1.75rem", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-subtle)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            ...
            <button
              ...
              style={{ padding: "0.7rem", background: "var(--accent-primary)", color: "#ffffff", borderRadius: "var(--radius-md)", fontWeight: 600, marginTop: "0.25rem" }}
            >
        ...
        <div style={{ background: "var(--bg-secondary)", padding: "1.75rem", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-subtle)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
            ...
            <button
              ...
              style={{ padding: "0.7rem", background: "rgba(239, 68, 68, 0.15)", color: "var(--status-danger)", border: "1px solid rgba(239, 68, 68, 0.3)", borderRadius: "var(--radius-md)", fontWeight: 600, marginTop: "0.25rem" }}
            >
